...
tf.app.flags.DEFINE_string('eval_dir', '/tf_tmp/cifar10_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/tf_tmp/cifar10_train',
...
def eval_once(saver, summary_writer, logits, summary_op):
  ...
  with tf.Session() as sess:
    ...
    try:
      ...
      #   step += 1
      _summary_op, prediction = sess.run([summary_op, logits])
